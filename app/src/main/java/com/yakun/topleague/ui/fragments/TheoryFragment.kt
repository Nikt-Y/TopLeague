...
import com.yakun.topleague.ui.adapters.MyLecturesListAdapter
...
class TheoryFragment : BaseFragment() {
    ...
    override fun onResume() {
        ...
        if (depth == 0) {
            ...
            getLecturesListFromFireStore(selectedCourseID)
        }
        adminCheck()
    }
     ...
     *
     * @param lecturesList Will receive the lecture list from cloud firestore.
     */
    fun successLecturesListFromFireStore(lecturesList: ArrayList<Lecture>) {
        ...
        if (lecturesList.size > 0) {
            ...
            val adapterProducts = MyLecturesListAdapter(
                requireActivity(),
                lecturesList,
                this@TheoryFragment,
                admin
    ...
    private fun getCoursesListFromFireStore() {
        ...
        FirestoreClass().getCoursesList(this@TheoryFragment)
    }
        ...
        if (admin > 0) {
            ...
            iv_add.setOnClickListener {
                if (depth == 0) {
                    ...
                    val intent = Intent(activity, AddLectureActivity()::class.java)
     ...
     *
     * @param lectureID To specify which product need to be deleted.
     */
    fun deleteLecture(lectureID: String) {
        showAlertDialogToDeleteCourse(lectureID, Constants.LECTURES)
    }
    ...
    private fun showAlertDialogToDeleteCourse(recordID: String, collection: String) {
        ...
        builder.setPositiveButton(resources.getString(R.string.yes)) { dialogInterface, _ ->
            ...
            // Call the function of Firestore class.
            FirestoreClass().deleteRecord(this@TheoryFragment, recordID, collection)
    ...
    fun depthDown(courseID: String, courseName: String) {
        ...
        depth = 1
        getLecturesListFromFireStore(courseID)
    ...
    fun depthUp() {
        ...
        tv_title.text = "THEORY"
    }

    private fun getLecturesListFromFireStore(courseID: String) {
        // Show the progress dialog.
        showProgressDialog(resources.getString(R.string.please_wait))

        // Call the function of Firestore class.
        FirestoreClass().getLecturesList(this@TheoryFragment, courseID)
    }
}