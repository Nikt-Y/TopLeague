 ...
 */
open class MyLecturesListAdapter(
    private val context: Context,
    private var list: ArrayList<Lecture>,
    private val fragment: TheoryFragment,
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.ib_delete_product.setOnClickListener {
                fragment.deleteLecture(model.lecture_id)
            }
            if (admin > 0) {
            ...
            holder.itemView.setOnClickListener {
                Log.e("My", model.lecture_id)
                // Launch Product details screen.
                val intent = Intent(context, TheoryDetailsActivity::class.java)
                intent.putExtra(Constants.EXTRA_PRODUCT_ID, model.lecture_id)
